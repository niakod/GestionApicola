...
public class Tramo {
	 ...
	 * @param siguiente Siguiente tramo.
	 */
	 ...
	 * @param puntoI Punto inicial del tramo.
	 * @param puntoF Punto final del tramo.
	 * @param peso Peso del tramo.
	 * @param siguiente Siguiente tramo-nodo de ListaTramo.
	 */
