...
public class Apiario extends Punto{
	 ...
	 * @param apicultor Apicultor encargado del apiario.
	 */
	 ...
	 * @param vNombre Nombre del apiario.
	 * @param vCoordX Coordenada del eje X.
	 * @param vCoordY Coordenada del eje Y.
	 * @param vCapacidad Capacidad en litros por mes.
	 * @param vApicultor Apicultor a cargo del apiario.
	 */
	public Apiario(String vNombre, double vCoordX, double vCoordY, int vCapacidad, Apicultor vApicultor) {
