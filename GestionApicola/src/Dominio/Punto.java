...
/**
 * De esta clase heredan todos los puntos geolocalizables (Ciudad,
 * CentroDeExtraccion y Apiario).
 */
public class Punto {
	/**
	 ...
	 * 
	 * @param nombre
	 *            Valor que se asignará al atributo nombre.
	 */
	 ...
	 * 
	 * @param coordX
	 *            Valor que se asignará a la coordenada del eje X del punto.
	 */
	 ...
	 * 
	 * @param coordY
	 *            Valor que se asignará al eje Y del punto.
	 */
	 ...
	 *            Nombre del punto.
	 * @param vCoordX
	 *            Valor de la coordenada para el eje X.
	 * @param vCoordY
	 *            Valor de la coordenada para el eje Y.
	 */
